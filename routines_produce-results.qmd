...
p_wdth <- 7 # plot width of ms plot, in cm
p_hgt <- 7*(6/10)
...
sprintf('the probability that the human data comes from the null distribution is p= %.2f for the lt exp, and p= .2f% for the ts exp', human_v_agent_ps['lt'], human_v_agent_ps['ts'])
